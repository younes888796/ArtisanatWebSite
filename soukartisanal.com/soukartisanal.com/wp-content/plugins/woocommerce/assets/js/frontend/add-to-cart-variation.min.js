! function(y, c, i, n) {
    ...
    t.prototype.onReset = function(t) {
        ...
        t = t.data.variationForm;
        t.$form.find('input[name="variation_id"], input.variation_id').val("").change(), t.$form.find(".wc-no-matching-variations").remove(), t.useAjax || t.$form.trigger("woocommerce_variation_select_change"), t.$form.trigger("check_variations"), t.$form.trigger("woocommerce_variation_has_changed")
        ...
        b.useAjax || (b.$attributeFields.each(function(t, a) {
            var i = y(a),
                ...
                s = i.val() || "",
                c = !0;
            i.data("attribute_html") || ((_ = i.clone()).find("option").removeAttr("disabled attached").removeAttr("selected"), i.data("attribute_options", _.find("option" + o).get()), i.data("attribute_html", _.html())), n.html(i.data("attribute_html"));
            var _ = y.extend(!0, {}, $);
            _[e] = "";
            ...
            a = n.find("option.attached").length, s && (c = !1, 0 !== a && n.find("option.attached.enabled").each(function() {
                var t = y(this).val();
                if (s === t) return !(c = !0)
            })), 0 < a && s && c && "no" === r && (n.find("option:first").remove(), o = ""), n.find("option" + o + ":not(.attached)").remove(), i.html(n.html()), i.find("option" + o + ":not(.enabled)").prop("disabled", !0), s ? c ? i.val(s) : i.val("").change() : i.val("")
